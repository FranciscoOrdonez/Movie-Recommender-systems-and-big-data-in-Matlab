...
The extraction downloads data into a zip file, unzip the file to have on disk the files movies.dat and ratings.dat. The movies.dat file is passed to a database table moviesTbl and the rating.dat file is passed to a database tall table ratingsTbl, through  
